// Iteration #1: Find the maximum  // การวนซ้ำ #1: ค้นหาค่าสูงสุด
...
// Iteration #2: Find longest word ค้นหาคำที่ยาวที่สุด
const words = [
  "mystery",
  "brother",
  "aviator",
...
function findLongestWord(words) {
  ...
  // conditional for passing test if array is empty   เงื่อนไขสำหรับการผ่านการทดสอบถ้าอาร์เรย์ว่างเปล่า
  if (words.length === 0) {
  ...
  //ลูปที่จะตรวจสอบแต่ละคำของอาร์เรย์กับตัวแปรเริ่มต้นและ อัปเดตตามนั้น
...
// Iteration #5: Unique arrays // อาเรย์ที่ไม่ซ้า
const wordsUnique = [
  "crab",
  "poison",
  "contagious",
...
function uniquifyArray(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    let word = arr[i];
    // indexOf() => returns 1 (true) if the word already exists in the array  ถ้าคำนั้นมีอยู่แล้วในอาร์เรย์
    // indexOf() => returns -1 (false) if the word doesn't exist in the array  ถ้าคำนั้นไม่มีอยู่ในอาร์เรย์
...
// Iteration #7: Count repetition / นับตัวซ้ำกัน
const wordsCount = [
  "machine",
  "matter",
  "subset",
...
function howManyTimes(arr, wordToSearch) {
  ...
  // conditional for passing test if array is empty
  //เงื่อนไขสำหรับการผ่านการทดสอบถ้าอาร์เรย์ว่างเปล่า 
  if (arr.length === 0) {
    return 0;
  }
...
console.log(doesWordExist(["ค้นหา","คำอะไรก็ได้"], "คำอะไรก็ได้"));  // ค้นหา
console.log(howManyTimes(["oat","oat","oat","a","a","o"],"oat")); // นับจำนวนตัวซ้ำจาก ข้อมูล
